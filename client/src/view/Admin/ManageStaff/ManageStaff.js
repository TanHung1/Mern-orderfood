...
function ManageStaff() {
        ...
        <div className="right-history">
          <div className="admin-right ">
            ...
            <div className="add-dish">
              {" "}
              <a className="dialog-btn" href="#add-staff">
                Thêm nhân viên
              </a>
            </div>
            ...
            <table className="staff-table">
              ...
              {data.accounts?.map((d, i) => (
                <tr key={i}>
                  <td className="staff-content">{d.username}</td>
                  <td className="staff-content">{d.phonenumber}</td>
  ...
  function handleDelete(id) {
    ...
    if (confirm) {
      axios.delete("http://localhost:3030/staffs/" + id).then((res) => {
