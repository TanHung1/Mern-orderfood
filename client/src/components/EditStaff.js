...
function EditStaff() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3030/staffs/" + id)
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .put("http://localhost:3030/staffs/" + id, inputData)
      .then((res) => {
        ...
        <div className="right-history">
          <div className="admin-right ">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div class="form-group">
                <label for="exampleFormControlInput1" className="lb-edit-staff">
                  Họ tên nhân viên
                </label>
                <input
                  type="text"
              ...
              <div class="form-group">
                <label for="exampleFormControlFile1" className="lb-edit-staff">
                  Số điện thoại
                </label>
                <input
                  type="text"
